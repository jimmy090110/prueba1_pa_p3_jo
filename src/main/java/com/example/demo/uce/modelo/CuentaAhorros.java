...
public class CuentaAhorros {
	...
	@Column(name="cuenta_ahorros_fecha_transferencia")
	private LocalDateTime fechaTransferencia;
	
	@Column(name="cuenta_ahorros_origen")
	private String cuentaOrigen;
	
	@Column(name="cuenta_ahorros_destino")
	private String cuentaDestino;
	
	@Column(name="cuenta_ahorros_monto")
	private BigDecimal montoTransferencia;
	
	@Column(name="cuenta_ahorros_comision")
